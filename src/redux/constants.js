...
//quick search tag result (in create post and upload document)
export const GET_TAG_QUICK_SEARCH_RESULT_REQUEST = "GET_TAG_QUICK_SEARCH_RESULT_REQUEST";
export const GET_TAG_QUICK_SEARCH_RESULT_SUCCESS = "GET_TAG_QUICK_SEARCH_RESULT_SUCCESS";
export const GET_TAG_QUICK_SEARCH_RESULT_FAILURE = "GET_TAG_QUICK_SEARCH_RESULT_FAILURE";
