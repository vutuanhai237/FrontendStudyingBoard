...
import Management_UserItem from 'components/management/Management_UserItem/Management_UserItem'
...
class Management_UserManagement extends Component {
            ...
            <div>
                ...
                <div className="Management_Show_Layout">
                    ...
                    <div className="display_flex justify_content_space_between margin_top_10px"  >
                        ...
                        < div className="position_relative display_flex">
    ...
    handleDropDownMenuItemClick = (roleName) => {
        let sub_dropdown_item_index = document.getElementsByName("User_Management_Role_Filter_Combobox_Item");
