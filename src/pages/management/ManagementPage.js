...
class ManagementPage extends Component {
                        ...
                        <Router>
                            <div>
                                <div>
                                    ...
                                    < div className="Management_Info_Menu_Layout" id="admin-left-sidebar" >

                                        {/* bounded for animation */}
                                        <div className="Bounded_Class_Infor_And_Archivement_Layout" id="bounded-class-infor-and-archivement-port">
                                            ...
                                            {(this.roleName === "ADMIN" || this.roleName === "COLLABORATOR") ?
                                                <div className="Tab_Menu">
                                                    <div className="Tab_Menu_Item_Layout_50_percents" >
                                                        <div className="Tab_Menu_Item_Layout" id="account-management-tab-menu-item" onClick={() => this.onAccountManagementTabMenuItemClicked()}>
                                                    ...
                                                    <div className="Tab_Menu_Item_Layout_50_percents">
                                                        <div className="Tab_Menu_Item_Layout" id="page-management-tab-menu-item" onClick={() => this.onPageManagementTabMenuItemClicked()}>
                                                            <div className="Tab_Menu_Item">
                                        ...
                                        < div className="Management_Vertical_Menu_Layout" id="admin-vertical-menu-port" >
    ...
    onAccountManagementTabMenuItemClicked = () => {
        if (document.getElementById("page-management-tab-menu-item")) {
            ...
            if (management_tab_menu_item.className === "Activated_Tab_Menu_Item_Layout") {
                management_tab_menu_item.className = "Tab_Menu_Item_Layout";
            }
            ...
            if (account_tab_menu_item.className === "Tab_Menu_Item_Layout") {
                account_tab_menu_item.className = "Activated_Tab_Menu_Item_Layout";
            }
    ...
    onPageManagementTabMenuItemClicked = () => {
        if (document.getElementById("page-management-tab-menu-item")) {
            ...
            if (management_tab_menu_item.className === "Tab_Menu_Item_Layout") {
                management_tab_menu_item.className = "Activated_Tab_Menu_Item_Layout";
            }
            ...
            if (account_tab_menu_item.className === "Activated_Tab_Menu_Item_Layout") {
                account_tab_menu_item.className = "Tab_Menu_Item_Layout";
            }
            if (account_management_container.style.display !== "hidden" && account_management_container.style.display !== "none") {
