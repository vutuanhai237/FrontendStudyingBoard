...
class Management_CategoryManagement extends Component {
    constructor(props) {
        super();
...
export default withRouter(connect(mapStatetoProps, mapDispatchToProps)(Management_CategoryManagement));
//#endregion
