            ...
            <div>
                ...
                >
                    <div className="Custom_Modal_Body">
                        <div className="Simple_Gray_Label_18px"> Tên quyền mới: </div>
                        <input type="text" className="Simple_Text_Input" placeholder="Nhập tên quyền ..." />
                    </div>
                ...
                >
                    <div className="Custom_Modal_Body">
                        <div className="Simple_Gray_Label_18px"> Tên quyền: </div>
